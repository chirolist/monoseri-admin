          ...
          <div class="row">
            <div class="col-md-12">
              <div class="card">
                ...
                <div class="card-body">
                  <form class="form-horizontal" action="{{ url('/bookmark/import') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="form-group row">
                      <label class="col-md-3 col-form-label" for="file-input">Bookmark html file</label>
                      <div class="col-md-9">
                        <input id="file-input" type="file" name="htmlfile">
                      </div>
                    </div>
